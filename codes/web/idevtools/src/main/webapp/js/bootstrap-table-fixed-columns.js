...
(function ($) {
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        $trs.each(function () {
            ...
            //$(this).find('th:gt(' + (that.options.fixedNumber -1) + ')').remove(); // Fix: Aleksej "-1" hinnzugeft. Denn immer eine Spalte Mehr geblieben ist
    ...
    /**
    * Add: Aleksej
    * Hook getCaret. Aktualisieren Header bei Fixed-Columns wenn diese sortiert wurden
    * @method getCaret
    * @for BootstrapTable
    */
